...
export class DiscountFormCreatePage {
	...
	constructor(page: Page) {
		...
		this.inputStartDate = this.page.getByRole('textbox', {
			name: 'Start date',
		});
		this.inputEnDate = this.page.getByRole('textbox', {
			name: 'End date',
		});
		...
		this.inputVaucherCode = this.page.getByRole('textbox', {
			name: 'Voucher code',
		});
		this.inputUsageLimit = this.page.getByRole('spinbutton', {
			name: 'Usage limit',
		});
		this.checkboxSingleUse = this.page.getByRole('checkbox', {
			name: 'Single use per user',
		});
		this.submitButton = this.page.getByRole('button', {
			name: 'Submit',
		});
		this.addProduct = this.page.getByRole('button').filter({
			hasText: 'add',
		});
		this.buttonConfirmProducts = this.page.getByRole('button', {
			name: 'Confirm',
		});
	}
