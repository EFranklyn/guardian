...
import type { ExtraAddon, ExtraAddonGroup } from '../../../schemas/addon';
...
export class AddonFormCreatePage {
	...
	constructor(page: Page) {
		...
		this.buttonAddAddon = this.page.getByRole('button', {
			name: 'Add Addon',
		});
		...
		this.inputRank = this.page.getByRole('spinbutton', {
			name: 'Rank',
		});
		this.inputMaxChoices = this.page.getByRole('spinbutton', {
			name: 'Max Choices',
		});
		this.inputMinChoices = this.page.getByRole('spinbutton', {
			name: 'Min Choices',
		});
		this.inputFreeAmount = this.page.getByRole('spinbutton', {
			name: 'Free Amount',
		});
		this.checkHideAddonsName = this.page.getByRole('checkbox', {
			name: 'Hide Addons Name',
		});
		this.checkShowName = this.page.getByRole('checkbox', {
			name: 'Show Name',
		});
		...
		this.addonInputName = this.formAddonModal.getByRole('textbox', {
			name: 'Name',
			exact: true,
		});
		this.addonInputName2 = this.formAddonModal.getByRole('textbox', {
			name: 'Name 2',
			exact: true,
		});
		this.addonInputPrice = this.formAddonModal.getByRole('textbox', {
			name: 'Price',
			exact: true,
		});
		this.addonInputTablePrice = this.formAddonModal.getByRole('textbox', {
			name: 'Table Price',
		});
		this.addonInputVatPrice = this.formAddonModal.getByRole('textbox', {
			name: 'VAT Price',
		});
		this.addonInputVatPerc = this.formAddonModal.getByRole('textbox', {
			name: 'VAT %',
		});
		this.addonInputDrsDeposit = this.formAddonModal.getByRole('textbox', {
			name: 'DRS Deposit',
		});
		this.addonCheckBoxDisabled = this.formAddonModal.getByRole('checkbox', {
			name: 'Disabled',
		});
		this.addonInputDescription = this.formAddonModal.getByRole('textbox', {
			name: 'Description',
		});
		this.addonDoneButton = this.page.getByRole('button', {
			name: 'Done',
			exact: true,
		});
		this.addonDoneNewButton = this.formAddonModal.getByRole('button', {
			name: 'Done and New',
			exact: true,
		});
	}
